    ...
    <div class="container-fluid py-2">
        ...
        <div class="row" id="hasil_container">
            <div class="card col-12 p-4">
                ...
                @if ($matrix_valid)
                @if (($is_valid) )
                <p class="alert alert-danger text-white py-2 w-30 text-center" style="font-size: 12px; background-color: blue;">Nilai Consistensi Ratio dan Consistensi Index valid</p>
                @else
                <p class="alert alert-danger text-white py-2 w-30 text-center" style="font-size: 12px; background-color: blue;">Nilai Consistensi Ratio dan Consistensi Index tidak valid, silahkan input kembali</p>
                @endif
                @endif
